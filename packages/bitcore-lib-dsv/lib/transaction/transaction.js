...
Transaction.MAX_MONEY = 84000000 * 1e8; // Doriancoin has 84M coins
...
Transaction.FEE_PER_KB = 100000; // Doriancoin default fees is 0.001 DSV
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' Use Transaction#uncheckedSerialize if you want to skip security checks. ' +
      'See http://doriancore.io/guide/transaction.html#Serialization for more info.';
 ...
 * and a slightly fancier format recognized by doriancore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a doriancore Address object. The
 * same is true for `script`, which can be a string or a doriancore Script.
 *
